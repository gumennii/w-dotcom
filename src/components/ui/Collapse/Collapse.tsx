...
const Collapse = React.forwardRef<HTMLDivElement, CollapseProps>(
  (
    { children, checkbox = true, open, arrowIcon = false, className, onOpen, onClose, onToggle, ...props },
    ref
  ): JSX.Element => {
    ...
    return (
      <div
        ...
        className={cn(
          "collapse",
          { "collapse-arrow": arrowIcon === true },
          { "collapse-open": isChecked === true },
          { "collapse-close": isChecked === false },
          className
        )}
        onBlur={handleBlur}
        onFocus={handleFocus}
