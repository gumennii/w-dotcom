...
import {
  ProductCardBody,
  type ProductCardBodyProps as BodyProps,
} from "./ProductCardBody";
import {
  ProductCardTitle,
  type ProductCardTitleProps as TitleProps,
} from "./ProductCardTitle";
import {
  ProductCardImage,
  type ProductCardImageProps as ImageProps,
    ...
    return (
      <div
        ...
        className={cn(
          "card",
          "product",
          "w-40 rounded-2xl sm:w-56 lg:w-96",
          className,
        )}
        ref={ref}
      />
