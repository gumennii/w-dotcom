    ...
    <div className="bg-primary sm:px-4 md:px-8 2xl:px-2">
      <Container maxWidth={MaxWidth.Footer}>
        {!content || !content.fields ? (
          <footer className="footer flex w-full flex-col items-center justify-center gap-4 py-10">
            <h6 className="text-xl text-white">Something went wrong!!!</h6>
            <p className="text-base text-white">Check your internet connection and reload the page.</p>
          </footer>
        ) : (
